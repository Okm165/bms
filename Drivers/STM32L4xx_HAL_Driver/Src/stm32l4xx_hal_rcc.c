...
/** @defgroup RCC_Exported_Functions_Group1 Initialization and de-initialization
 ...
 or through the PLL as System clock source.
         ...
         (+) MSI (Multiple Speed Internal): Its frequency is software trimmable
  ...
  if (RCC_OscInitStruct->PLL.PLLState != RCC_PLL_NONE) {
    ...
    if (RCC_OscInitStruct->PLL.PLLState == RCC_PLL_ON) {
      ...
      if (sysclk_source != RCC_CFGR_SWS_PLL) {
        ...
        /* Unselect main PLL clock source and disable main PLL outputs to save
         * power */
#if defined(RCC_PLLSAI2_SUPPORT)
  ...
  if (((RCC_ClkInitStruct->ClockType) & RCC_CLOCKTYPE_SYSCLK) ==
    ...
    defined(STM32L4S7xx) || defined(STM32L4S9xx)
      ...
      if (RCC_GetSysClockFreqFromPLLSource() > 80000000U) {
        /* If lowest HCLK prescaler, apply intermediate step with HCLK prescaler
         * 2 necessary before to go over 80Mhz */
    ...
    defined(STM32L4S7xx) || defined(STM32L4S9xx)
      ...
      if (HAL_RCC_GetSysClockFreq() > 80000000U) {
        /* If lowest HCLK prescaler, apply intermediate step with HCLK prescaler
         * 2 necessary before to go under 80Mhz */
        if (READ_BIT(RCC->CFGR, RCC_CFGR_HPRE) == RCC_SYSCLK_DIV1) {
          MODIFY_REG(RCC->CFGR, RCC_CFGR_HPRE, RCC_SYSCLK_DIV2);
          hpre = RCC_SYSCLK_DIV2;
        }
